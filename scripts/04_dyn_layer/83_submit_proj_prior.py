...
# -*- coding: utf-8 -*-
#
# 83_submit_proj_prior.py
#
# Submits the Projection & Prior DLS method sweeps to the SLURM queue.
...
#SBATCH --job-name=dls_proj_{trait}
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=log/dls_proj_{trait}.out
#SBATCH --error=log/dls_proj_{trait}.err
...
echo "Running Proj & Prior DLS sweep for {trait}..."

# Loop over values and run the script
...
def main():
    job_dir = Path("jobs/dls_proj_prior")
