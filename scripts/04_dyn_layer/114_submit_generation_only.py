...
# -*- coding: utf-8 -*-
#
# 114_submit_generation_only.py
#
# Submits text generation jobs for all 9 dynamic layer steering methods (5 unmasked, 4 PDF-masked)
...
#SBATCH --job-name=gen_raw_fixed_seed_{trait}
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=03:00:00
#SBATCH --output=log/gen_raw_fixed_seed_{trait}.out
#SBATCH --error=log/gen_raw_fixed_seed_{trait}.err
...
echo "Starting text generation on test prompts for {trait}..."
...
echo "Text generation completed on test prompts for {trait}."
"""

def main():
    job_dir = Path("jobs/gen_raw_fixed_seed")
    ...
    for trait in TRAITS:
        ...
        print(f"Submitting text generation job for {trait}...")
