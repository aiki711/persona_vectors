...
class ICAdaptiveSteerer:
    ...
    def update_ic(self, logits):
        ...
        # Normalize IC: 
        # Mistral vocab size 32k. log2(32000) approx 15.
        # We want IC factor to be low for common tokens (is/the) and high for rare ones.
        # Common tokens have high prob (e.g. 0.1 -> IC 3.3). Rare tokens (0.0001 -> IC 13.3).
        # We shift it so that common tokens have near 0 factor.
        self.ic_factor = max(0.0, surprisal - 3.0) / 10.0 # Heuristic normalization
