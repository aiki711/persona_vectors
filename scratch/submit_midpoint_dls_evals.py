...
# -*- coding: utf-8 -*-
#
# scratch/submit_midpoint_dls_evals.py
#
# Submits evaluation jobs for midpoint DLS results (cos_only & rank_only).
...
for val in {vals_list}; do
    ...
    if [ ! -f "$JSONL_OUT" ]; then
        ...
        JSONL_OUT_INT="exp_steering_dyn_layer_proj_prior/results/{trait}/{mode}_only_Val${{val}}.jsonl"
...
def main():
    ...
    job_dir = Path("jobs/eval_midpoint_sweeps")
