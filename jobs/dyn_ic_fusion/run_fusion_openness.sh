#!/bin/bash
#SBATCH --job-name=dyn_ic_openness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=log/dyn_ic_openness.out
#SBATCH --error=log/dyn_ic_openness.err
...
for MODE in "${IC_MODES[@]}"; do
    for AMAX in "${AMAXES[@]}"; do
        echo "Running DLS + IC Fusion: Trait=openness, Mode=$MODE, AlphaMax=$AMAX"
