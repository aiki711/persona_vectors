#!/bin/bash
#SBATCH --job-name=dyn_rel_extraversion
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=log/dyn_rel_extraversion.out
#SBATCH --error=log/dyn_rel_extraversion.err
...
for V in "${VALS[@]}"; do
    echo "Running Relative Anti-Alignment DLS: Trait=extraversion, Alpha=$V"
