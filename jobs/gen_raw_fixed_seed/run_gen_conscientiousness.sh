#!/bin/bash
#SBATCH --job-name=gen_raw_fixed_seed_conscientiousness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=03:00:00
#SBATCH --output=log/gen_raw_fixed_seed_conscientiousness.out
#SBATCH --error=log/gen_raw_fixed_seed_conscientiousness.err
...
echo "Starting text generation on test prompts for conscientiousness..."
...
echo "Text generation completed on test prompts for conscientiousness."
