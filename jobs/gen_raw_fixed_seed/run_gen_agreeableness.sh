#!/bin/bash
#SBATCH --job-name=gen_raw_fixed_seed_agreeableness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=03:00:00
#SBATCH --output=log/gen_raw_fixed_seed_agreeableness.out
#SBATCH --error=log/gen_raw_fixed_seed_agreeableness.err
...
echo "Starting text generation on test prompts for agreeableness..."
...
echo "Text generation completed on test prompts for agreeableness."
