#!/bin/bash
#SBATCH --job-name=gen_raw_fixed_seed_extraversion
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=03:00:00
#SBATCH --output=log/gen_raw_fixed_seed_extraversion.out
#SBATCH --error=log/gen_raw_fixed_seed_extraversion.err
...
echo "Starting text generation on test prompts for extraversion..."
...
echo "Text generation completed on test prompts for extraversion."
