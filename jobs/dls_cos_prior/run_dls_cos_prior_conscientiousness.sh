#!/bin/bash
#SBATCH --job-name=dls_cos_prior_conscientiousness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=log/dls_cos_prior_conscientiousness.out
#SBATCH --error=log/dls_cos_prior_conscientiousness.err
...
echo "Running Cos-Prior DLS sweep for conscientiousness..."
