#!/bin/bash
#SBATCH --job-name=dls_proj_only_neuroticism
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=log/dls_proj_only_neuroticism.out
#SBATCH --error=log/dls_proj_only_neuroticism.err
...
echo "Running Proj-Only DLS sweep for neuroticism..."
