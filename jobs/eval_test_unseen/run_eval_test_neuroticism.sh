#!/bin/bash
#SBATCH --job-name=eval_dls_test_neuroticism
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=12:00:00
#SBATCH --output=log/eval_dls_test_neuroticism.out
#SBATCH --error=log/eval_dls_test_neuroticism.err
...
echo "Starting evaluation on unseen test prompts for neuroticism..."
...
for val in 0.5 1.0 2.0 4.0 5.0 6.0 8.0 10.0 15.0 20.0 25.0 30.0 35.0 40.0; do
    ...
    JSONL_OUT="${OUT_DIR}/neuroticism/cos_prior_Val${val}.jsonl"
    CSV_OUT="${OUT_DIR}/neuroticism/scores_cos_prior_Val${val}.csv"
...
echo "Evaluation completed on unseen test prompts for neuroticism."
