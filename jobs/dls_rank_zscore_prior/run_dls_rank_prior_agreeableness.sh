#!/bin/bash
#SBATCH --job-name=dls_rank_prior_agreeableness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=04:00:00
#SBATCH --output=log/dls_rank_prior_agreeableness.out
#SBATCH --error=log/dls_rank_prior_agreeableness.err
...
echo "Running rank-Prior DLS sweep for agreeableness..."
