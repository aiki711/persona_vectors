#!/bin/bash
#SBATCH --job-name=eval_gen_time_alpha5_neuroticism
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=02:00:00
#SBATCH --output=log/eval_gen_time_alpha5_neuroticism.out
#SBATCH --error=log/eval_gen_time_alpha5_neuroticism.err
