#!/bin/bash
#SBATCH --job-name=dlis_dyn_ng_neuroticism_a8.0
#SBATCH --output=/home/s2550009/persona_vectors/log/02_token_intensity_dynamic_no_gating/dlis_dyn_ng_neuroticism_a8.0.log
#SBATCH --error=/home/s2550009/persona_vectors/log/02_token_intensity_dynamic_no_gating/dlis_dyn_ng_neuroticism_a8.0.err
