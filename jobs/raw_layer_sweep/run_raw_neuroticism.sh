#!/bin/bash
#SBATCH --job-name=raw_sweep_neuroticism
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=12:00:00
#SBATCH --output=log/raw_sweep_neuroticism.out
#SBATCH --error=log/raw_sweep_neuroticism.err
...
echo "Running raw single-layer sweep for neuroticism..."
