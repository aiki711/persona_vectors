#!/bin/bash
#SBATCH --job-name=gen_time_local_proj_agreeableness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=03:00:00
#SBATCH --output=log/gen_time_local_proj_agreeableness.out
#SBATCH --error=log/gen_time_local_proj_agreeableness.err
...
echo "Starting generation-time Local Proj-Rank sweeps for agreeableness..."
...
echo "Generation-time Local Proj-Rank sweeps completed for agreeableness."
