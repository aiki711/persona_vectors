#!/bin/bash
#SBATCH --job-name=midpoint_norm_sweep_conscientiousness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=12:00:00
#SBATCH --output=log/midpoint_norm_sweep_conscientiousness.out
#SBATCH --error=log/midpoint_norm_sweep_conscientiousness.err
...
echo "Running midpoint-norm scaled single-layer sweep for conscientiousness..."
