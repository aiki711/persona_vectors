#!/bin/bash
#SBATCH --job-name=gen_sim_rank_agreeableness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=04:00:00
#SBATCH --output=log/gen_sim_rank_agreeableness.out
#SBATCH --error=log/gen_sim_rank_agreeableness.err
...
echo "Similarity-based Rank/Proj-Rank sweeps completed for agreeableness."
