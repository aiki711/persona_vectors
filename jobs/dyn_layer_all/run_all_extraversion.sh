#!/bin/bash
#SBATCH --job-name=dyn_all_extraversion
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=log/dyn_all_extraversion.out
#SBATCH --error=log/dyn_all_extraversion.err
...
for V in "${VALS[@]}"; do
    ...
    echo "Running DLS Z-score logit_diff: Trait=extraversion, Alpha=$V"
    ...
    echo "Running DLS Z-score anti_alignment: Trait=extraversion, Alpha=$V"
    ...
    echo "Running DLS Relative Anti-alignment: Trait=extraversion, Alpha=$V"
    JSONL_OUT="${OUT_DIR}/extraversion/relative_anti_alignment_Val${V}.jsonl"
    CSV_OUT="${OUT_DIR}/extraversion/scores_relative_anti_alignment_Val${V}.csv"
