#!/bin/bash
#SBATCH --job-name=sl_gp_masked_proj_rank_agreeableness
#SBATCH --output=/home/s2550009/persona_vectors/log/static_layer_grouped/sl_gp_masked_proj_rank_agreeableness.log
#SBATCH --error=/home/s2550009/persona_vectors/log/static_layer_grouped/sl_gp_masked_proj_rank_agreeableness.err
...
python scripts/04_dyn_layer/02_token_intensity/batch_eval.py \
    --file /home/s2550009/persona_vectors/exp_token_intensity/exp_static_layer/results/agreeableness/masked_proj_rank_theta_3.0_7.0_k_2.0_2.0_Val5.0.jsonl \
    --axis agreeableness \
    --quant 4bit
...
python scripts/04_dyn_layer/02_token_intensity/batch_eval.py \
    --file /home/s2550009/persona_vectors/exp_token_intensity/exp_static_layer/results/agreeableness/masked_proj_rank_theta_1.0_9.0_k_2.0_2.0_Val5.0.jsonl \
    --axis agreeableness \
    --quant 4bit
...
python scripts/04_dyn_layer/02_token_intensity/batch_eval.py \
    --file /home/s2550009/persona_vectors/exp_token_intensity/exp_static_layer/results/agreeableness/masked_proj_rank_theta_4.0_6.0_k_2.0_2.0_Val5.0.jsonl \
    --axis agreeableness \
    --quant 4bit
...
python scripts/04_dyn_layer/02_token_intensity/batch_eval.py \
    --file /home/s2550009/persona_vectors/exp_token_intensity/exp_static_layer/results/agreeableness/masked_proj_rank_theta_3.0_7.0_k_8.0_8.0_Val5.0.jsonl \
    --axis agreeableness \
    --quant 4bit
...
python scripts/04_dyn_layer/02_token_intensity/batch_eval.py \
    --file /home/s2550009/persona_vectors/exp_token_intensity/exp_static_layer/results/agreeableness/masked_proj_rank_theta_3.0_7.0_k_0.5_0.5_Val5.0.jsonl \
    --axis agreeableness \
    --quant 4bit
