#!/bin/bash
#SBATCH --job-name=gen_sim_rank_openness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=04:00:00
#SBATCH --output=log/gen_sim_rank_openness.out
#SBATCH --error=log/gen_sim_rank_openness.err
...
echo "Starting Similarity-based Rank/Proj-Rank sweeps for openness..."
...
echo "Similarity-based Rank/Proj-Rank sweeps completed for openness."
