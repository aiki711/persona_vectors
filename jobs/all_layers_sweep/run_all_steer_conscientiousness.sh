#!/bin/bash
#SBATCH --job-name=all_steer_conscientiousness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=08:00:00
#SBATCH --output=log/all_steer_conscientiousness.out
#SBATCH --error=log/all_steer_conscientiousness.err
...
echo "Running Full-Layer (32 layers) single-layer sweep for conscientiousness..."
