#!/bin/bash
#SBATCH --job-name=dyn_mid_all_openness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=log/dyn_mid_all_openness.out
#SBATCH --error=log/dyn_mid_all_openness.err
...
for V in "${VALS[@]}"; do
    ...
    echo "Running DLS Z-score logit_diff (Midpoint): Trait=openness, Alpha=$V"
    ...
    echo "Running DLS Z-score anti_alignment (Midpoint): Trait=openness, Alpha=$V"
