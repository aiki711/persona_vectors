#!/bin/bash
#SBATCH --job-name=dyn_mid_all_neuroticism
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=log/dyn_mid_all_neuroticism.out
#SBATCH --error=log/dyn_mid_all_neuroticism.err
...
for V in "${VALS[@]}"; do
    ...
    echo "Running DLS Z-score logit_diff (Midpoint): Trait=neuroticism, Alpha=$V"
    ...
    echo "Running DLS Z-score anti_alignment (Midpoint): Trait=neuroticism, Alpha=$V"
