#!/bin/bash
#SBATCH --job-name=dls_norm_extraversion
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=12:00:00
#SBATCH --output=log/dls_norm_extraversion.out
#SBATCH --error=log/dls_norm_extraversion.err
...
echo "Starting text generation with norm DLS for extraversion..."
...
"$PYTHON_BIN" scripts/04_dyn_layer/88_batch_eval_pdf.py --axis extraversion --model "$JUDGE_MODEL" --results_dir "$OUT_DIR" --methods cos_only rank_only logit_diff

echo "Completed DLS norm run and evaluation for extraversion."
