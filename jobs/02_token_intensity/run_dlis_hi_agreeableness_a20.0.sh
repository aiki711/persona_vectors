#!/bin/bash
#SBATCH --job-name=dlis_hi_agreeableness_a20.0
#SBATCH --output=/home/s2550009/persona_vectors/log/02_token_intensity/dlis_hi_agreeableness_a20.0.log
#SBATCH --error=/home/s2550009/persona_vectors/log/02_token_intensity/dlis_hi_agreeableness_a20.0.err
