#!/bin/bash
#SBATCH --job-name=dlis_neuroticism_conf2_proj_rank
#SBATCH --output=/home/s2550009/persona_vectors/log/02_token_intensity/dlis_neuroticism_conf2_proj_rank.log
#SBATCH --error=/home/s2550009/persona_vectors/log/02_token_intensity/dlis_neuroticism_conf2_proj_rank.err
