#!/bin/bash
#SBATCH --job-name=sl_masked_proj_cosine_conf6_neuroticism
#SBATCH --output=/home/s2550009/persona_vectors/log/static_layer/sl_masked_proj_cosine_conf6_neuroticism.log
#SBATCH --error=/home/s2550009/persona_vectors/log/static_layer/sl_masked_proj_cosine_conf6_neuroticism.err
