#!/bin/bash
#SBATCH --job-name=sl_proj_rank_conf4_extraversion
#SBATCH --output=/home/s2550009/persona_vectors/log/static_layer/sl_proj_rank_conf4_extraversion.log
#SBATCH --error=/home/s2550009/persona_vectors/log/static_layer/sl_proj_rank_conf4_extraversion.err
