#!/bin/bash
#SBATCH --job-name=sl_proj_rank_conf5_neuroticism
#SBATCH --output=/home/s2550009/persona_vectors/log/static_layer/sl_proj_rank_conf5_neuroticism.log
#SBATCH --error=/home/s2550009/persona_vectors/log/static_layer/sl_proj_rank_conf5_neuroticism.err
