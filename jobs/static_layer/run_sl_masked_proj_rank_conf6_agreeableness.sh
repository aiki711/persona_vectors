#!/bin/bash
#SBATCH --job-name=sl_masked_proj_rank_conf6_agreeableness
#SBATCH --output=/home/s2550009/persona_vectors/log/static_layer/sl_masked_proj_rank_conf6_agreeableness.log
#SBATCH --error=/home/s2550009/persona_vectors/log/static_layer/sl_masked_proj_rank_conf6_agreeableness.err
