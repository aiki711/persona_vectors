#!/bin/bash
#SBATCH --job-name=sl_proj_rank_conf2_agreeableness
#SBATCH --output=/home/s2550009/persona_vectors/log/static_layer/sl_proj_rank_conf2_agreeableness.log
#SBATCH --error=/home/s2550009/persona_vectors/log/static_layer/sl_proj_rank_conf2_agreeableness.err
