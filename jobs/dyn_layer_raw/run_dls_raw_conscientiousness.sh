#!/bin/bash
#SBATCH --job-name=dls_raw_conscientiousness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=12:00:00
#SBATCH --output=log/dls_raw_conscientiousness.out
#SBATCH --error=log/dls_raw_conscientiousness.err
...
echo "Starting text generation with raw DLS for conscientiousness..."
...
echo "Completed DLS raw run and evaluation for conscientiousness."
