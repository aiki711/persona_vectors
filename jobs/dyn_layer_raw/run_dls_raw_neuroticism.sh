#!/bin/bash
#SBATCH --job-name=dls_raw_neuroticism
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=12:00:00
#SBATCH --output=log/dls_raw_neuroticism.out
#SBATCH --error=log/dls_raw_neuroticism.err
...
echo "Starting text generation with raw DLS for neuroticism..."
...
echo "Completed DLS raw run and evaluation for neuroticism."
