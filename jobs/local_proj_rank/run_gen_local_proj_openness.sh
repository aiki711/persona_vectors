#!/bin/bash
#SBATCH --job-name=gen_local_proj_openness
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=03:00:00
#SBATCH --output=log/gen_local_proj_openness.out
#SBATCH --error=log/gen_local_proj_openness.err
...
echo "Starting Local Proj-Rank sweeps for openness..."
...
echo "Local Proj-Rank sweeps completed for openness."
