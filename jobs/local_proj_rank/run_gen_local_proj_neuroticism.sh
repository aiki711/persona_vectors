#!/bin/bash
#SBATCH --job-name=gen_local_proj_neuroticism
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=03:00:00
#SBATCH --output=log/gen_local_proj_neuroticism.out
#SBATCH --error=log/gen_local_proj_neuroticism.err
...
echo "Starting Local Proj-Rank sweeps for neuroticism..."
...
echo "Local Proj-Rank sweeps completed for neuroticism."
