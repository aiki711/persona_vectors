#!/bin/bash
#SBATCH --job-name=gen_local_proj_extraversion
#SBATCH --partition=GPU-1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:nvidia_a40:1
#SBATCH --time=03:00:00
#SBATCH --output=log/gen_local_proj_extraversion.out
#SBATCH --error=log/gen_local_proj_extraversion.err
...
echo "Starting Local Proj-Rank sweeps for extraversion..."
...
echo "Local Proj-Rank sweeps completed for extraversion."
